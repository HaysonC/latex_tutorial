...
% In main.tex:
\documentclass[11pt]{article}
\input{preamble}  % Loads preamble.tex
...
\Part{Sections, Subsections and Paragraphs}
LaTeX provides commands to structure your document into sections, subsections, and paragraphs.
\subsection*{Creating Sections and Subsections}
Use the following commands to create sections and subsections:
\begin{tcolorbox}[colback=codeGray, title=\textbf{Sectioning Commands}]
\begin{verbatim}
\section{Section Title}          % Creates a new section
This is some text
\subsection{Subsection Title}    % Creates a new subsection
This is some more text
\subsubsection{Subsubsection Title} % Creates a new subsubsection
This is even more text

The paragraph command creates a new paragraph.
It indents the first line of the paragraph.
\paragraph{Paragraph Title}      % Creates a new paragraph
This is the text of the paragraph.

\paragraph{}
This is another paragraph without a title.
\end{verbatim}
\end{tcolorbox}
...
\begin{itemize}[nosep]
    ...
    \item Captions should be above the actual table for tables (for figures, captions go below, this is standard convention).
\end{itemize}
